...
for replicate = 1:100
    ...
    for cali_item_index = 1:length(index_cali)
        ...
        target1 = [min(2,(k-b(cali_item))*a(cali_item,1)/(a(cali_item,1)^2+a(cali_item,2)^2)), min(2,(k-b(cali_item))*a(cali_item,2)/(a(cali_item,1)^2+a(cali_item,2)^2))]; 
        ...
        target4 = [max(-2,-(k+b(cali_item))*a(cali_item,1)/(a(cali_item,1)^2+a(cali_item,2)^2)) max(-2,-(k+b(cali_item))*a(cali_item,2)/(a(cali_item,1)^2+a(cali_item,2)^2))]; %focus on first
%        
