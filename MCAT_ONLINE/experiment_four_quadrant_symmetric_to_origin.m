...
for replicate = 1:100
    ...
    for cali_item_index = 1:length(index_cali)
        ...
        logit_optimal = untitled(b(cali_item));
    
        target1 = [min(2,logit_optimal*a(cali_item,1)/(a(cali_item,1)^2+a(cali_item,2)^2)), min(2,logit_optimal*a(cali_item,2)/(a(cali_item,1)^2+a(cali_item,2)^2))]; 
        target2 = [max(-2,-2*a(cali_item,2)/a(cali_item,1)) min( 2, 2*a(cali_item,1)/a(cali_item,2))];
        target3 = [min( 2, 2*a(cali_item,2)/a(cali_item,1)) max(-2,-2*a(cali_item,1)/a(cali_item,2))];
        target4 = [max(-2,-logit_optimal*a(cali_item,1)/(a(cali_item,1)^2+a(cali_item,2)^2)) max(-2,-logit_optimal*a(cali_item,2)/(a(cali_item,1)^2+a(cali_item,2)^2))]; %focus on first
