...
%
parameter1 = math0808parlink;     %%%%%%%%%%%%%need to change
parameter2 = math0809parlink;     %%%%%%%%%%%%%need to change
...
% get all calibrated results
I = setdiff(1:n,I08);             %%%%%%%%%%%%%need to change twice
Idsquare = setdiff(1:n,Id08_01); %%%%%%%%%%%%%need to change twice
Iman = setdiff(1:n,Im08_01);     %%%%%%%%%%%%%need to change twice

cali_test1 = m0808par;            %%%%%%%%%%%%%need to change
cali_test2 = m0809par;            %%%%%%%%%%%%%need to change
...
%% conduct linking using items selected by tcc method
    ...
    if test1 <= test2 
        ...
        conversion_result=[raw_score1 tcc_score];
    elseif test1 > test2
        ...
        %report conversion table
        conversion_result=[tcc_score raw_score2];
    end   
...
if ~isempty(Idsquare)
    ...
    if test1 <= test2 
        ...
        %report conversion table
        conversion_result=[conversion_result d_score];
    elseif test1 > test2
        ...
        %report conversion table
        conversion_result=[d_score conversion_result];
    end
...
if ~isempty(Iman)
    ...
    if test1 <= test2 
        ...
        %report conversion table
        conversion_result=[conversion_result man_score];
    elseif test1 > test2
        ...
        %report conversion table
        conversion_result=[man_score conversion_result];
    end
else
