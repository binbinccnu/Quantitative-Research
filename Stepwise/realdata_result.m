...
load('/Users/Aurora/Dropbox/research/TCC/TCC_revise_2/simulation/real data/2008parlink.mat')
load('/Users/Aurora/Dropbox/research/TCC/TCC_revise_2/simulation/real data/2009parlink.mat')
%% real data results
I03=[4;10;17;38;47];
I04=[13;31;36;37;49];
...
load('/Users/Aurora/Dropbox/research/TCC/TCC_revise_2/simulation/real data/2008par.mat')
load('/Users/Aurora/Dropbox/research/TCC/TCC_revise_2/simulation/real data/2009par.mat')
cali_test1 = m0308par;
cali_test2 = m0309par;
...
if  ~isempty(I)
    ...
    elseif test1 > test2
        tcc_score=zeros(length(raw_score2),1);
        ...
        %report conversion table
        conversion_tcc=[tcc_score raw_score2];
    end   
...
if ~isempty(Idsquare)
    ...
    if test1 <= test2 
        ...
        for j_score=1:length(raw_score1)     
            d_score(j_score)=conversion(raw_score1(j_score),cali_test1(:,1),cali_test1(:,2),cali_test1(:,3),tcc_test2(:,1),tcc_test2(:,2),tcc_test2(:,3),D,1);   
        end
        %report conversion table
    ...
    elseif test1 > test2
        ...
        for j_score=1:length(raw_score2)     
            d_score(j_score)=conversion(raw_score2(j_score),cali_test1(:,1),cali_test1(:,2),cali_test1(:,3),tcc_test2(:,1),tcc_test2(:,2),tcc_test2(:,3),D,2);   
        end
        %report conversion table
        conversion_d=[d_score raw_score2];
    end
...
if ~isempty(Iman)
    ...
    if test1 <= test2 
        ...
        for j_score=1:length(raw_score1)     
            man_score(j_score)=conversion(raw_score1(j_score),cali_test1(:,1),cali_test1(:,2),cali_test1(:,3),tcc_test2(:,1),tcc_test2(:,2),tcc_test2(:,3),D,1);   
        end
        %report conversion table
    ...
    elseif test1 > test2
        ...
        for j_score=1:length(raw_score2)     
            man_score(j_score)=conversion(raw_score2(j_score),cali_test1(:,1),cali_test1(:,2),cali_test1(:,3),tcc_test2(:,1),tcc_test2(:,2),tcc_test2(:,3),D,2);   
        end
        %report conversion table
        conversion_man=[man_score raw_score2];
    end
else
