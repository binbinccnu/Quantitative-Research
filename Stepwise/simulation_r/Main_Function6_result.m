...
if  ~isempty(I)
    ...
    for j_score=1:length(raw_score)
        tcc_score(j_score)=conversion(raw_score(j_score),trupar_test1(:,2),trupar_test1(:,3),trupar_test1(:,4),tcc_test2(:,1),tcc_test2(:,2),tcc_test2(:,3),D);
    end
...
if ~isempty(Idsquare)
    ...
    for j_score=1:length(raw_score)
        d_score(j_score)=conversion(raw_score(j_score),trupar_test1(:,2),trupar_test1(:,3),trupar_test1(:,4),d_test2(:,1),d_test2(:,2),d_test2(:,3),D);
    end
    if y==repli
...
if ~isempty(Iman)
    ...
    for j_score=1:length(raw_score)
        man_score(j_score)=conversion(raw_score(j_score),trupar_test1(:,2),trupar_test1(:,3),trupar_test1(:,4),man_test2(:,1),man_test2(:,2),man_test2(:,3),D);
    end
    if y==repli
